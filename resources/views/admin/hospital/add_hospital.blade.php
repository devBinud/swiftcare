    ...
    <div class="container">
        <div class="card">
            <div class="card-header">
                <div class="row">
                    <div class="col-md-6">
                        <h4 class="fw-bold">Add New Hospital</h4>
                    </div>
            ...
            <!--end card-header-->
            <div class="card-body">
                <form action="" method="post" id="formAddHospital" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-lg-3">
                            <div class="form-floating mb-3">
                                <input name="hospital_name" type="text" class="form-control" id="flotingInput"
                                    placeholder="Enter name of the hospital" required>
                                <label for="flotingInput">Hospital Name</label>
                                <div class="error"></div>
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-3">
                        ...
                        <div class="col-12">
                            <div class="form-group mb-3">
                                <label class="mb-1">Departments</label> <br>
                                <select name="departments[]" id="departments" class="form-control mb-3" style="width: 100% !important;"
                                    multiple="multiple">
                        ...
                        <div class="col-12">
                            <div class="row">
                                <div class="col-lg-6">
                                    <h6 class="fw-bold">Hospital Image (Thumbnail)</h6>
                                    <div class="col-12">
                                        <div class="card">
                                            <div class="card-body">
                        ...
                        <div class="col-12 mt-3">
                            <button id="btnSubmit" class="btn btn-primary waves-effect waves-light" type="submit">
                                ...
                                <span id="btnSubmitText">Save Hospital</span>
                            </button>
                        </div>
                    </div>
                </form>
...
@section('custom-js')
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#formAddHospital').submit(function(e) {
                e.preventDefault();
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        Swal.mixin({
                            ...
                            window.location.replace("{{ url(config('app.url_prefix.admin') . '/hospital') }}");
                        });
                    },
                    complete: function() {
