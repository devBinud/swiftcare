...
<head>
    <meta charset="utf-8" />
    <title>Login - Hospital | {{ config('app.name') }}</title>
...
<body class="account-body" style="background: lightcyan;">
                ...
                <div class="row">
                    <div class="col-lg-5 mx-auto">
                        ...
                        <div class="card"
                            ...
                            <div class="card-body p-0 p-3 bg-info">
                                <div class="text-center">
                                    <h4 class="fw-bold m-0 text-white font-18">Hospital Login</h4>
                                    <p class="text-light m-0">Sign in to continue to hospital panel.</p>
                                </div>
                            </div>
                                            ...
                                            <div class="form-group mb-2">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" class="form-control" name="username"
                                                        id="phoneEmail" placeholder="Enter username">
                                                </div>
                                            </div>
                                            <!--end form-group-->
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        Swal.mixin({
                            ...
                            window.location.replace("{{ url('hospital/dashboard') }}");
                        });
                    },
                    complete: function() {
