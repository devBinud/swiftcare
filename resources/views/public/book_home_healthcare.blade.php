        ...
        <div class="content__wrapper">
            <div class="container">
                <div class="upper__layer__text py-3">
                    <h3 class='layer__para__second fw-medium'>Home Healthcare Solutions</h3>
                    <p class='layer__para__first'>
                    Get quality healthcare from the comfort of your own home with our compassionate and skilled healthcare professionals.
                    </p>
                </div>
                <div class="form__wrapper bg-white">
                    <div class="row">
                        <div class="col-lg-7">
                            <form action="" class="p-lg-5 p-3 text-main" id="formBook" method="post">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 py-2">
                                    <div class="form-floating mb-3">
                                        <input type="text" class="form-control " id="age" placeholder="Health issue">
                        ...
                        <div class="col-lg-5 order-2 order-lg-1 d-flex align-items-center justify-content-center">
                            <lottie-player src="{{ asset('resources/lottifiles/home_healthcare.json') }}"
